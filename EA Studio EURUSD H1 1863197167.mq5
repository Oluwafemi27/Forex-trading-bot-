...
static input int    Magic_Number = 1863197167; // Magic number
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":78,"takeProfit":46,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Accelerator Oscillator","listIndexes":[5,0,0,0,0],"numValues":[0,0,0,0,0,0]},{"name":"Williams' Percent Range","listIndexes":[4,0,0,0,0],"numValues":[11,-46,0,0,0,0]}],"closeFilters":[{"name":"Standard Deviation","listIndexes":[5,3,0,0,0],"numValues":[43,0.07,0,0,0,0]},{"name":"Envelopes","listIndexes":[3,3,0,0,0],"numValues":[30,0.31,0,0,0,0]}]} */
