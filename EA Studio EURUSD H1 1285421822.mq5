...
static input int    Magic_Number = 1285421822; // Magic number
static input double Entry_Amount =     0.10; // Entry lots
       input int    Stop_Loss    =       67; // Stop Loss   (pips)
       input int    Take_Profit  =        0; // Take Profit (pips)

static input string ___0______   = "------"; // --- Moving Average of Oscillator ---
       input int    Ind0Param0   =       20; // Fast EMA
       input int    Ind0Param1   =       31; // Slow EMA
       input int    Ind0Param2   =        7; // MACD SMA
       input double Ind0Param3   =   0.0000; // Level

static input string ___1______   = "------"; // --- Average True Range ---
       input int    Ind1Param0   =       10; // Period
       input double Ind1Param1   =   0.0100; // Level

static input string ___2______   = "------"; // --- Moving Averages Crossover ---
       input int    Ind2Param0   =        9; // Fast MA period
       input int    Ind2Param1   =       39; // Slow MA period

static input string ___3______   = "------"; // --- RSI ---
       input int    Ind3Param0   =       30; // Period
       input int    Ind3Param1   =       30; // Level

static input string ___4______   = "------"; // --- Alligator ---
       input int    Ind4Param0   =       24; // Jaws period
       input int    Ind4Param1   =       23; // Jaws shift
       input int    Ind4Param2   =       23; // Teeth period
       input int    Ind4Param3   =       10; // Teeth shift
       input int    Ind4Param4   =       10; // Lips period
       input int    Ind4Param5   =        2; // Lips shift
...
void InitIndicators(void)
  {
   // Moving Average of Oscillator (Close, 20, 31, 7), Level: 0.0000
   ...
   // Moving Averages Crossover (Simple, Simple, 9, 39)
   ...
   // Alligator (Smoothed, Median, 24, 23, 23, 10, 10, 2)
   indHandlers[0][4][0] = iAlligator(NULL, 0, Ind4Param0, Ind4Param1, Ind4Param2, Ind4Param3, Ind4Param4, Ind4Param5, MODE_SMMA, PRICE_MEDIAN);
...
void ManageClose(void)
  {
   ...
   double ind4buffer2[]; CopyBuffer(indHandlers[0][4][0], 2, 1, 2, ind4buffer2);
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":67,"takeProfit":100,"useStopLoss":true,"useTakeProfit":false,"isTrailingStop":false},"openFilters":[{"name":"Moving Average of Oscillator","listIndexes":[5,3,0,0,0],"numValues":[20,31,7,0,0,0]},{"name":"Average True Range","listIndexes":[6,0,0,0,0],"numValues":[10,0.01,0,0,0,0]},{"name":"Moving Averages Crossover","listIndexes":[3,0,0,0,0],"numValues":[9,39,0,0,0,0]}],"closeFilters":[{"name":"RSI","listIndexes":[7,3,0,0,0],"numValues":[30,30,0,0,0,0]},{"name":"Alligator","listIndexes":[10,3,4,0,0],"numValues":[24,23,23,10,10,2]}]} */
