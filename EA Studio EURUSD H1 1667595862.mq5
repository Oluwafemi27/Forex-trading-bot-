...
static input int    Magic_Number = 1667595862; // Magic number
...
static input string ___0______   = "------"; // --- Envelopes ---
       input int    Ind0Param0   =        2; // Period
       input double Ind0Param1   =     0.38; // Deviation %
...
static input string ___2______   = "------"; // --- Alligator ---
       input int    Ind2Param0   =       29; // Jaws period
       input int    Ind2Param1   =       18; // Jaws shift
       input int    Ind2Param2   =       18; // Teeth period
       input int    Ind2Param3   =        9; // Teeth shift
       input int    Ind2Param4   =        9; // Lips period
...
void InitIndicators(void)
  {
   ...
   // Alligator (Smoothed, Median, 29, 18, 18, 9, 9, 1)
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":10,"takeProfit":88,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Envelopes","listIndexes":[4,3,0,0,0],"numValues":[2,0.38,0,0,0,0]}],"closeFilters":[{"name":"Bears Power","listIndexes":[0,0,0,0,0],"numValues":[37,0,0,0,0,0]},{"name":"Alligator","listIndexes":[4,3,4,0,0],"numValues":[29,18,18,9,9,1]}]} */
